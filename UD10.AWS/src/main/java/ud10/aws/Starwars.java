...
public class Starwars {
	...
	private static final String AWSDNS = "databasevbici.c7ljt30yvviy.us-east-1.rds.amazonaws.com";
	...
	public static void main(String[] args) {
		...
		AWSDNS+":"+PUERTO+"/"+DBNAME,USERNAME,PASSWORD);) {
			...
			System.out.println("Elige un número de película y te mostraré los personajes que"
					+ " aparecen en ella: ");
			...
			while (rs2.next()) {
				System.out.println(rs2.getInt(1)+" "+rs2.getString(2)+" "+rs.getInt(3)+" "+rs2.getFloat(4)+" "+rs2.getString(5)+" "+rs2.getString(6));
			}
			con.close();
		} catch (Exception e) {
